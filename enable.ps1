#################################################
# HelloID-Conn-Prov-Target-MyAcademy-Enable
# PowerShell V2
#################################################
...
try {
    ...
    if ($($ex.Exception.GetType().FullName -eq 'Microsoft.PowerShell.Commands.HttpResponseException') -or
        ...
        $auditLogMessage = "Could not enable MyAcademy account: [$($actionContext.References.Account)]. Error: $($errorObj.FriendlyMessage)"
